...
/mob/proc/playsound_local(turf/turf_source, soundin, vol as num, vary, frequency, falloff, channel = 0, pressure_affected = TRUE, sound/S, soundwet = -10000, sounddry = 0)
	if(!client || !can_hear())
		return
	...
	if(isturf(turf_source))
		...
		if(pressure_affected)
			...
			S.echo = list(sounddry, null, soundwet, null, null, null, null, null, null, null, null, null, null, 1, 1, 1, null, null)
